...
import 'package:repondo/features/despensa/application/providers/usecases/exports.dart';
...
DespensaFacade despensaFacade(Ref ref) {
  ...
  final fetchDespensaUseCase = ref.read(fetchDespensaUseCaseProvider);

  return DespensaFacade(
    createDespensaUseCase: createDespensaUseCase,
    fetchDespensaUseCase: fetchDespensaUseCase,
  );
}
